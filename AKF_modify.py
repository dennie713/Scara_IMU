...
#================================================ 2. WLS加權最小平方法回歸 ================================================#
        ...
        # # 回歸預測結果
        # vel_pred = X @ beta_wls_vel
        # acc_pred = X @ beta_wls_acc
