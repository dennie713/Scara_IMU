...
import zero_phase_filter, AKF_modify, AKF
...
if __name__ == "__main__":
    ...
    # IMU實際收回二軸加速度資料
    path = 'data/IMU_data5.txt'
    data = np.genfromtxt(path, delimiter=' ')
    data = np.array(data)
    i = data[start_size1:data_size1, 0] 
    gyro_x = data[start_size1:data_size1, 1] # rad/s
    gyro_y = data[start_size1:data_size1, 2] 
    gyro_z = data[start_size1:data_size1, 3]
    acc_x = data[start_size1:data_size1, 1] # G
    acc_y = data[start_size1:data_size1, 2] 
    acc_z = data[start_size1:data_size1, 3]  
#-------------------------------------------------------------------#
    dt2 = 0.001      
    start_size2 = 0 # 1700
    data_size2 = 12000
...
#-------------------------------------------------------------------#
    ...
    filtered_acc_x = zero_phase_filter.zero_phase_filter(3, 45, acc_x) # 50/12
    filtered_acc_y = zero_phase_filter.zero_phase_filter(3, 45, acc_y)
    # x方向
    plt.figure(figsize=(8, 4))
    plt.subplot(2, 1, 1)
    plt.title("Acc_x", loc="center")
    plt.plot(t1, acc_x, label="acc_x", linewidth=1)
    plt.plot(t1, filtered_acc_x, label="filtered_acc_x", linewidth=1)
    ...
    plt.plot(t1, acc_y, label="acc_y", linewidth=1)
    plt.plot(t1, filtered_acc_y, label="filtered_acc_y", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("acc(G)")
    plt.subplot(2, 1, 2)
    ...
    plt.ylabel("acc(G)")
    plt.subplot(2, 1, 2)
    plt.plot(t1, filtered_vel_x, label="filtered_vel_x", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("vel(G)")
    # y方向
    ...
    plt.ylabel("acc(G)")
    plt.subplot(2, 1, 2)
    plt.plot(t1, filtered_vel_y, label="filtered_vel_y", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("vel(G)")
#-------------------------------------------------------------------#
...
#=================================================馬達速度估測=================================================#
    # pose, vele, acce, Q_pos, Q_acc, Q_vel, u_p_values, u_v_values, u_a_values, Q_save, x_data_all, P_data_all, vel1_values, vel2_values, acc1_values, acc2_values, x_RTS = AKF_modify.AKF(dt2, pos_2)
    ...
    plt.figure(figsize=(8, 4))
    plt.subplot(2, 1, 1)
    plt.title("Scara & IMU Data", loc="center")
    print("pos_1 = ", pos_1)
    # plt.plot(t1, q1_dot_data, label="q1_dot", linewidth=1)
    plt.plot(t1, gyro_x, label="gyro_x", linewidth=1)
    plt.plot(t1, gyro_y, label="gyro_y", linewidth=1)
    plt.plot(t1, gyro_z, label="gyro_z", linewidth=1)
    # plt.plot(t2, vele, label="vele", linewidth=1)
    # plt.plot(t2, vele, label="vele", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("vel(rad/s)")
    plt.subplot(2, 1, 2)
    # plt.plot(t1, q2_dot_data, label="q2_dot", linewidth=1)
    # plt.plot(t2[160:], vele[160:], label="vel", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("vel(rad/s)")
    ...
    print("pos_1 = ", pos_1)
    # plt.plot(t1, q1_dot_data, label="q1_dot", linewidth=1)
    plt.plot(t1, filtered_acc_x/(l1/1000), label="acc_x", linewidth=1)
    plt.plot(t1, filtered_acc_y/(l1/1000), label="acc_y", linewidth=1)
    # plt.plot(t1, acc_z/l1, label="acc_z", linewidth=1)
    # plt.plot(t2, acce, label="acce", linewidth=1)
    # plt.plot(t2, vele, label="vele", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    ...
    plt.subplot(2, 1, 2)
    # plt.plot(t1, q2_dot_data, label="q2_dot", linewidth=1)
    # plt.plot(t2[160:], acce[160:], label="acc", linewidth=1)
    plt.legend(loc='upper right')
    plt.xlabel("t")
    plt.ylabel("acc(rad/s^2)")
    ...
    print("pos_1 = ", pos_1)
    # plt.plot(t1, q1_dot_data, label="q1_dot", linewidth=1)
    plt.plot(t2, vel_1, label="acc_x", linewidth=1)
    # plt.plot(t1, filtered_acc_y/(l1/1000), label="acc_y", linewidth=1)
    # plt.plot(t1, acc_z/l1, label="acc_z", linewidth=1)
    # plt.plot(t2, acce, label="acce", linewidth=1)
    # plt.plot(t2, vele, label="vele", linewidth=1)
